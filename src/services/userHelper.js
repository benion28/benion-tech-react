...
export const smsClasses = [
    { name: "Kindergarten 1", value: "kg1" },
    { name: "Kindergarten 2", value: "kg2" },
    { name: "Nursery 1", value: "nur1" },
    { name: "Nursery 2", value: "nur2" },
    { name: "Nursery 3", value: "nur3" },
    { name: "Primary 1", value: "pri1" },
    { name: "Primary 2", value: "pri2" },
    { name: "Primary 3", value: "pri3" },
    { name: "Primary 4", value: "pri4" },
    { name: "Primary 5", value: "pri5" },
    { name: "Primary 6", value: "pri6" },
    { name: "JSS 1", value: "js1" },
    { name: "JSS 2", value: "js2" },
    { name: "JSS 3", value: "js3" },
    { name: "SSS 1", value: "ss1" },
    { name: "SSS 2", value: "ss2" },
    { name: "SSS 3", value: "ss3" }
]
...
export const smsSubjects = [
    { name: "Mathematics", value: "maths" },
    { name: "English Language", value: "english" },
    { name: "Hausa Language", value: "hausa" },
    { name: "French Language", value: "french" },
    { name: "Igbo Language", value: "igbo" },
    { name: "Yoruba Language", value: "yoruba" },
    { name: "Christain Religious Studies", value: "crs" },
    { name: "Islamic Religion Studies", value: "irs" },
    { name: "Chemistry", value: "chemistry" },
    { name: "Physics", value: "physics" },
    { name: "Economics", value: "economics" },
    { name: "Computer Science", value: "computer" },
    { name: "Biology", value: "biology" },
    { name: "Commerce", value: "commerce" },
    { name: "Book Keeping", value: "bkeeping" },
    { name: "Entrepreneurship", value: "ent" },
    { name: "Quantitative Reasoning", value: "qreason" },
    { name: "Verbal Reasoning", value: "vreason" },
    { name: "Social Studies", value: "sstu" },
    { name: "Handwriting", value: "handwriting" },
    { name: "Cultural and Creative Arts", value: "ccarts" },
    { name: "Social Studies", value: "sstu" },
    { name: "Literature In English", value: "literature" },
    { name: "Government", value: "government" },
    { name: "Security Education", value: "secedu" },
    { name: "Physical Health Education", value: "phe" },
    { name: "Arabic", value: "arabic" },
    { name: "Marketing", value: "marketting" },
    { name: "Civic Education", value: "civuc" },
    { name: "Basic Science", value: "bsci" },
    { name: "Basic Technology", value: "btech" },
    { name: "Business Studies", value: "bstudies" },
    { name: "Agricultural Sciences", value: "agric" },
    { name: "Animal Husbandry", value: "ahusby" },
    { name: "Technical Drawing", value: "tdraw" },
    { name: "Social Habits", value: "shabits" },
    { name: "Health Habits", value: "hhabits" },
    { name: "Song / Rhymes", value: "srhym" },
    { name: "Home Economics", value: "hecons" },
    { name: "Geography", value: "geography" },
    { name: "Further Mathematics", value: "further" },
    { name: "Accounting", value: "accounting" },
    { name: "Quran", value: "quran" },
    { name: "Oral Reading", value: "oread" },
]
